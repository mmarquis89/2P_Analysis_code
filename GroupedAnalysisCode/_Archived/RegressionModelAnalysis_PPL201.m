classdef RegressionModelAnalysis_PPL201
% ==================================================================================================
%
% Properties:
%       sourceData (table)
...
methods
    ...
    % Constructor
    function obj = RegressionModelAnalysis_PPL201(expInfoTbl, sourceDataParams)
        ...
        load(fullfile(dataDir, 'Saved_AlignEvent_objects', '20201231_AlignEventObj_odor.mat'), ...
                'alignObj');
        ...
        load(fullfile(dataDir, 'Saved_DataTable_objects', fileName), 'dt')
        disp('Loading complete')
        ...
        for iExp = 1:numel(expInfoTbl.expID)
            ...
            for iTrial = 1:numel(trialNums)
                ...
                if strcmp(sourceDataParams.speedType, 'moveSpeed')
                    currFwSpeed = repeat_smooth(currFt.moveSpeed{:}, smReps, ...
                            'smWin', smWinFrames);
                else
                    currFwSpeed = repeat_smooth(currFt.fwSpeed{:}, smReps, ...
                            'smWin', smWinFrames);
                end
                currFwSpeed(currFwSpeed > maxSpeed) = maxSpeed;
                currYawSpeed = abs(repeat_smooth(currFt.yawSpeed{:}, ...
            ...
            filterDefs = alignObj.create_filterDefs('loadOneNoteData', 0);
...
%             filterDefs.locomotion = 0;
            ...
            moveSpeedArr = cell2mat(dt.subset.moveSpeed');
