function [yhat, yhat_odor, yhat_moveSpeed] = nlmFun_no_odorHist(beta, x)
...
intercept = beta(5);     % intercept term
...
yhat = b_odor*yhat_odor + b_moveSpeed*yhat_moveSpeed + intercept;
yhat = yhat';
